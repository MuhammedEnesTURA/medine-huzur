  ...
  return (
    <header className="sticky top-0 z-50 bg-panel/92 shadow-[0_10px_34px_rgba(0,0,0,0.07)] backdrop-blur-2xl">
      ...
      <div className="page-container">
        ...
        <div className="flex items-center gap-2 overflow-x-auto border-t border-border-soft/70 py-2 lg:hidden">
          ...
          <Link href="/products" className={mobilePillClass(isActive("/products"))}>
            Ürünler
          </Link>
        </div>
        ...
        {categoriesOpen && (
          <div className="fixed left-1/2 top-[70px] z-[70] hidden w-[min(960px,calc(100vw-48px))] -translate-x-1/2 rounded-[1.65rem] border border-border-soft bg-panel/98 p-5 shadow-[0_28px_90px_rgba(0,0,0,0.28)] backdrop-blur-xl lg:block">
