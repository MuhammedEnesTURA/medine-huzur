          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-sm leading-7 text-muted">
                ...
                bilgilendirme. Yayına çıkmadan önce gerçek işletme prosedürleri
                ve hukuki metinlerle güncellenmelidir.
              </p>
            </div>
            ...
            <section className="rounded-2xl border border-mhgreen/25 bg-mhgreen/10 p-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-7 text-muted">
                    Bu metin taslaktır. Yayına çıkmadan önce iade adresi, kargo
                    anlaşması, ürün gruplarına göre iade istisnaları ve hukuki
                    hükümler netleştirilmelidir.
                  </p>
                </div>
              </div>
            </section>
