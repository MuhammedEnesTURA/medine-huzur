          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-sm leading-7 text-muted">
                ...
                arasındaki temel hak ve yükümlülükleri açıklamak için taslak
                olarak hazırlanmıştır. Yayına çıkmadan önce gerçek işletme
          ...
          <div className="mt-8 grid gap-5">
            ...
            <section className="rounded-2xl border border-border-soft bg-panel/65 p-4">
              ...
              <p className="mt-2 text-sm leading-7 text-muted">
                ...
                kabul etmesiyle oluşturulur. Ödeme entegrasyonu aktif olduğunda
                ödeme sağlayıcı üzerinden ödeme alınır ve ödeme sonucu siparişe
                işlenir.
              </p>
            </section>
            ...
            <section className="rounded-2xl border border-mhgreen/25 bg-mhgreen/10 p-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-7 text-muted">
                    Bu sözleşme metni taslaktır. Yayına çıkmadan önce gerçek
                    satıcı bilgileri, iade koşulları, kargo politikası ve hukuki
                    hükümler profesyonel şekilde kontrol edilmelidir.
                  </p>
                </div>
              </div>
            </section>
