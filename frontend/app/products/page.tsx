...
export default async function ProductsPage({ searchParams }: ProductsPageProps) {
  ...
  return (
    <div className="page-shell">
      <section className="page-container pt-4 md:pt-5">
        <div className="rounded-[1.35rem] border border-border-soft bg-panel/72 px-4 py-4 shadow-[0_18px_50px_rgba(0,0,0,0.24)] sm:px-5">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="w-fit rounded-2xl border border-border-soft bg-panel-2 px-4 py-3">
      ...
      <section className="page-container mt-4">
        <div className="overflow-hidden rounded-[1.35rem] border border-border-soft bg-panel/72 shadow-[0_18px_50px_rgba(0,0,0,0.2)]">
          <div className="border-b border-border-soft px-3 py-3 sm:px-4">
              ...
              <Link
                ...
                className={`shrink-0 rounded-full border px-3.5 py-1.5 text-xs font-black transition ${
                  !categoryId
                    ...
                    : "border-border-soft bg-panel-2 text-muted hover:text-foreground"
                }`}
              >
                Tüm Ürünler
              </Link>
          ...
          <details className="group" open={hasAdvancedFilters}>
            <summary className="flex cursor-pointer list-none items-center justify-between gap-3 px-3 py-2.5 transition hover:bg-panel-3/45 sm:px-4">
              ...
              <span className="rounded-full border border-border-soft px-3 py-1 text-[11px] font-black text-muted">
                Aç / Kapat
              </span>
            </summary>
            ...
            <form
              action="/products"
              className="border-t border-border-soft bg-[#020806]/70 p-3 sm:p-4"
            >
          ...
          {hasAnyFilter && (
            <div className="flex flex-wrap items-center gap-2 border-t border-border-soft px-3 py-2.5 sm:px-4">
      ...
      <section className="page-container mt-4">
        {products.items.length === 0 ? (
          <div className="page-panel-soft flex min-h-[260px] flex-col items-center justify-center p-8 text-center">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-border-soft bg-panel-3">
            ...
            <Link href="/products" className="btn-premium mt-4 min-h-10 text-sm">
              Tüm ürünlere dön
            </Link>
          </div>
        ) : (
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4">
              {products.items.map((product) => {
                ...
                return (
                  <article
                    key={product.id}
                    className="group overflow-hidden rounded-[1.15rem] border border-border-soft bg-panel/72 p-2 shadow-[0_14px_42px_rgba(0,0,0,0.2)] transition hover:-translate-y-1 hover:border-border-strong"
                  >
                    <Link href={`/product/${product.slug}`} className="block">
                      <div className="relative flex aspect-[4/3] items-center justify-center overflow-hidden rounded-2xl border border-border-soft bg-panel-3">
                        ...
                        <div className="absolute left-2 top-2 flex gap-1.5">
                          {product.isFeatured && (
                            <span className="rounded-full border border-mhgreen/30 bg-[#020806]/80 px-2 py-1 text-[10px] font-black text-mhgreen backdrop-blur">
                              Öne çıkan
                            </span>
                          )}
                        </div>
                        ...
                        {product.stock <= 0 && (
                          <span className="absolute right-2 top-2 rounded-full border border-danger/30 bg-[#020806]/80 px-2 py-1 text-[10px] font-black text-danger backdrop-blur">
                            Stok yok
                          </span>
                        )}
                      </div>
