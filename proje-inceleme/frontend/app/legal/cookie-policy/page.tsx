          ...
          <div className="mt-8 grid gap-5">
            ...
            <Section title="5. Analiz ve Performans Çerezleri">
              <p>
                ...
                performansı ölçmek için analiz araçları kullanılabilir. Bu tür araçlar kullanıldığında ziyaretçi deneyimini iyileştirme,
site performansını ölçme ve hizmet kalitesini artırma amaçlarıyla
değerlendirilir.
              </p>
            </Section>
